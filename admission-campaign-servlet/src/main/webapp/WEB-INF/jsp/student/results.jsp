...
<html>
    <head>
        ...
        <title><fmt:message key="results" bundle="${application}"/></title>
    ...
    <body>
        ...
        <h3 class="title"><fmt:message key="results" bundle="${application}"/></h3>
                ...
                <table class="results-table-2">
                    <tbody>
                        <c:forEach items="${exams}" var="exam">
                            <tr>
                                <td><fmt:message key="${exam.subject}" bundle="${application}"/></td>
                                <td>${exam.mark}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
