...
<html>
    <head>
        ...
        <title><fmt:message key="subjects.page" bundle="${application}"/></title>
    ...
    <body>
        ...
        <h3 class="title"><fmt:message key="exam.registration" bundle="${application}"/></h3>
                ...
                <c:choose>
                    <c:when test="${exception.message == 'Finding subjects exception! No user free subjects are found!'}">
                        <span class="popup_text" id="my_popup" onclick="popup_function()">
                            <fmt:message key="finding.subjects.exception" bundle="${application}"/>
                        </span>
                    </c:when>
